            ...
            if ( (browserName == "Netscape") && (parseInt(browserVersion) >= 3)) browserName = "M";

            else if ( (browserName == "Microsoft Internet Explorer") && (parseInt(browserVersion) >= 3) ) browserName = "N";
            ...
            function myErrorTrap(message,url,linenumber) {
                ...
                alert("Sorry, I can'N process this." + cr +" Press 'Example' for general information.");
...
<title>Simplex Method Tool</title>

<meta name = "Simplex Method Utility" content = "Part of the Finite Math & Applied Calculus resource site at http://www.zweigmedia.com/RealWorld ">
...
<td align = center>
<table><tr><td>
<td><a href="LPGrapher/lpg.html"> Linear Programming Grapher</a></td>
<td width = 10></td>
...
<td><script language="Javascript">writeMailtag('')</script>
</td>
<td width = 10></td>
<td><a href = "../MundoReal/simplex.html">Lleveme a la P&aacute;gina Espa&ntilde;ol</a></td>
</tr>
</table>
</td>
</tr>
...
<textarea name = "input" rows = 10 cols = 80>
</textarea>
...
<br>Copyright &#169  Stefan Waner</i></font>
...
<!-- text below generated by server. PLEASE REMOVE --><!-- Counter/Statistics data collection code --><script language="JavaScript" src="http://l.yimg.com/d/lib/smb/js/hosting/cp/js_source/whv2_001.js"></script><script language="javascript">geovisit();</script><noscript><img src="http://visit.webhosting.yahoo.com/visit.gif?us1400425981" alt="setstats" border="0" width="1" height="1"></noscript><script type="text/javascript" src="https://s.yimg.com/mi/vs4/ywa.js"></script><script type="text/javascript">try {var YWAGTracker = YWA.getTracker("10001849413879", "VSCALE4");YWAGTracker.setDocumentName("WPAGE");YWAGTracker.setDocumentGroup("YSBW");YWAGTracker.setCF(7, "zweigmedia.com");YWAGTracker.setCF(8, "w19");YWAGTracker.submit();} catch (eYWATCUnavailable) {}</script><script type="text/javascript">(function (d, w) {var x = d.getElementsByTagName('SCRIPT')[0];var f = function () {var s = d.createElement('SCRIPT');s.type = 'text/javascript';s.async = true;s.src = "//np.lexity.com/embed/YW/527354410ebd5e605016e7f5446e3c29?id=d0c702d4d3ac";x.parentNode.insertBefore(s, x);};w.attachEvent ? w.attachEvent('onload',f) :w.addEventListener('load',f,false);}(document, window));</script>